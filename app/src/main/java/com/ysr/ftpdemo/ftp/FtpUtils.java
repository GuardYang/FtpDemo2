package com.ysr.ftpdemo.ftp;

import android.content.Context;

import com.ysr.ftpdemo.MainActivity;
...
public class FtpUtils {
    ...
    public FtpUtils(String hostName,int serverPort,String userName,String password) {
    ...
    public static boolean TestFtp(String ip,int port,String user,String pwd,String path){
        FTPClient ftp = FtpUtils.connectFtp(ip,port,user,pwd);
        if(ftp==null){
            return false;
        }
        if(!path.equals("")){
